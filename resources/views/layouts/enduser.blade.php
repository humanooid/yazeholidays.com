                                ...
                                <ul id="mainmenu">
                                    <li><a class="menu-item" href="/home">Home</a>
                                        <!-- <ul>
                                            ...
                                            <li><a class="menu-item" href="index-7.html">New: Homepage 7</a></li>
                                        </ul> -->
                                    </li>
                                    ...
                                    <li class="nav-item"><a class="nav-link menu-item" href="#section-cars">Booking</a></li>
                                    ...
                                    <li class="nav-item"><a class="nav-link menu-item" href="#section-news">News</a>
                                        <!-- <ul>
