                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" id="title" class="form-control" name="title" value="{{ $article->title }}" aria-label="Judul Artikel" placeholder="Masukkan judul Artikel Anda disini !" required>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="input-group">
                                    <input type="text" id="writer" class="form-control" name="writer" value="{{ $article->writer }}" aria-label="Penulis" placeholder="Masukkan nama Penulis disini !" required>
                                </div>
                            </div>
                        </div>
                        <div class="card">
